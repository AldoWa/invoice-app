...
const fontBase = "text-[0.9375rem] leading-[0.9375rem] tracking-widest font-bold"

const controlStyles = {
  base: `border rounded-[4px] bg-white dark:bg-invoice-03 hover:cursor-pointer ${fontBase} dark:text-white`,
  focus: "border-invoice-01 ring-1 ring-invoice-01 dark:border-invoice-04 dark:ring-invoice:04",
